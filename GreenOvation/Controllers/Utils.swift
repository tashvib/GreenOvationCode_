...
//
//    // Create a bright green border
//    let borderLayer = CALayer()
//    borderLayer.borderColor = UIColor.green.cgColor //set to custom passed in color
//    borderLayer.borderWidth = 2
//    borderLayer.frame = bounds
//    shapeLayer.addSublayer(borderLayer)
//
//    shapeLayer.backgroundColor = UIColor.clear.cgColor //set to custom passed in color
//    return shapeLayer
//}
func createRectLayer(_ bounds: CGRect, withColor color: UIColor) -> CALayer {
    let shapeLayer = CALayer()
    shapeLayer.bounds = bounds
    shapeLayer.position = CGPoint(x: bounds.midX, y: bounds.midY)

    // Create a border with the custom color
    let borderLayer = CALayer()
